...
// ✅ NEW GET TASKS WITH FILTERS
// @desc    Get tasks
// @route   GET /api/tasks
// @access  Private
exports.getTasks = async (req, res) => {
  try {
    const { projectId, status, priority, assignedTo, createdBy, notAssignedToMe, dueDate } = req.query;
...
exports.updateTask = async (req, res) => {
  try {
    ...
    if (req.body.status === 'completed' && oldStatus !== 'completed') task.completedAt = new Date();
